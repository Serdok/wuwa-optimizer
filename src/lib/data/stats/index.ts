...
export const ELEMENT_BONUS = ['general_bonus', 'physical_bonus', 'glacio_bonus', 'fusion_bonus', 'electro_bonus', 'aero_bonus', 'spectro_bonus', 'havoc_bonus'] as const;
...
export const ELEMENT_AMPLIFY = ['general_amplify', 'physical_amplify', 'glacio_amplify', 'fusion_amplify', 'electro_amplify', 'aero_amplify', 'spectro_amplify', 'havoc_amplify'] as const;
...
export const EXTRA_STATS = ['skill_multiplier', 'enemy_def_ignore'] as const;
...
export type StatValue = { stat: StatKey, value: number, };
